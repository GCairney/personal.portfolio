  ...
  return (
    <div>
      ...
      <main className="flex flex-col items-center justify-between min-h-screen p-24">
        ...
        <div className="z-10 items-center justify-between w-full max-w-3xl font-mono text-sm lg:flex">
          ...
          <Image
            ...
            src={`${prefix}/me.jpg`}
            alt="Next.js Logo"
            width={270} //a 10th of the size of the original photo in width and height
            height={378}
            priority
          />
        </div>
